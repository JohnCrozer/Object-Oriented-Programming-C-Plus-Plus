...
/*
 * @brief changes the age of the Person object
 * 
 * @param new_age int: new age of the Person object
 */
...
/*
 * @brief changes the occupation of the Person object
 * 
 * @param new_occupation string: The new occupation of the Person object
 */
...
/**
 * @brief returns the name of person
 * 
 * @return string 
 */
...
int Person::getAge() const{
 ...
 bool Person::isOlderThan(const Person& b) const{
    if(age > b.getAge())
      return true; 
    else
      return false;
