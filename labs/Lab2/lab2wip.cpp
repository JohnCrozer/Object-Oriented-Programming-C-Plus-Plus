 ...
 * {9/22/2023}
 * 
 * {Students will organize code into functions, apply prototypes and implement a mix of pass by reference calls and will use github}
 * 
...
// write print function here
 ...
 {
     cout << "Output of " << operation << " between " << x << " and " << y << " is : " << output << endl;
 }
